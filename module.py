...
def setting():
    ...
    class_explain=[
        ...
        "적운은 쎈구름, 뭉게구름 이라고도 하며, 날씨가 맑고 한낮 기온이 높을 경우 고기압권에서 대류작용으로 형성되는 구름이야구리.",
        "난층운은 비층구름, 비구름이라고도 하며, 비교적 낮은 고도에서 하늘을 가득 채운 짙은 회색빛의 먹구름이야구리. 비나 눈이 계속 내릴 것 같아구리.",
        "층적운은 두루마리구름이라고도 하며, 종종 어두운 벌집처럼 보이는 회색 또는 흰색의 얼룩덜룩한 구름이야구리. 날씨가 지금은 좋지만 폭풍이 다가올 것 같아구리."
    ]
